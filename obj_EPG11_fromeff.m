...
function [obj, grad,FF] = obj_EPG11_fromeff(thetain,ESP,T1,T2,c,B1,target)
...
% ZMH 2024 modification to input effective theta

[Ns, Nch] = size(B1);
F0 = 0;

np = size(thetain, 2); %length(params)/(2*Nch);
